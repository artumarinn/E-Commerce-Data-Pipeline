...
WITH base AS (
    SELECT 
        ...
        CASE STRFTIME('%m', o.order_purchase_timestamp)
            ...
            WHEN '12' THEN 'Dec'
        END AS month,
        STRFTIME('%Y', o.order_purchase_timestamp) AS year_val,
...
SELECT 
    month_no,
    month,
    AVG(CASE WHEN year_val = '2016' THEN real_time END) AS Year2016_real_time,
    AVG(CASE WHEN year_val = '2017' THEN real_time END) AS Year2017_real_time,
    AVG(CASE WHEN year_val = '2018' THEN real_time END) AS Year2018_real_time,
    AVG(CASE WHEN year_val = '2016' THEN estimated_time END) AS Year2016_estimated_time,
    AVG(CASE WHEN year_val = '2017' THEN estimated_time END) AS Year2017_estimated_time,
    AVG(CASE WHEN year_val = '2018' THEN estimated_time END) AS Year2018_estimated_time
FROM base
